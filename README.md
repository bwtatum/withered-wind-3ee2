...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/withered-wind-3ee2)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/withered-wind-3ee2
```

A live public deployment of this template is available at [https://withered-wind-3ee2.templates.workers.dev](https://withered-wind-3ee2.templates.workers.dev)
